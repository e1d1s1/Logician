...
%MSBUILD_PATH% "EDSEngine\EDSEngine2013.vcxproj" /t:clean,rebuild /p:Configuration="Debug" /p:VisualStudioVersion=12.0 /p:Platform=Win32
%MSBUILD_PATH% "EDSEngine\EDSEngine2013.vcxproj" /t:clean,rebuild /p:Configuration="Release" /p:VisualStudioVersion=12.0 /p:Platform=Win32
%MSBUILD_PATH% "EDSEngine\EDSEngine2013.vcxproj" /t:clean,rebuild /p:Configuration="Debug" /p:VisualStudioVersion=12.0 /p:Platform=x64
%MSBUILD_PATH% "EDSEngine\EDSEngine2013.vcxproj" /t:clean,rebuild /p:Configuration="Release" /p:VisualStudioVersion=12.0 /p:Platform=x64
copy "EDSEngine\Release\*.lib" VC12 /y
copy "EDSEngine\x64\Release\*.lib" VC12\x64 /y
echo "EDSEngine build complete"

echo "Building EDSEngineTestApp..."
%MSBUILD_PATH% "EDSEngine\EDSEngineTestApp\EDSEngineTestApp2013.vcxproj" /t:clean,rebuild /p:Configuration="Debug" /p:VisualStudioVersion=12.0 /p:Platform=Win32
%MSBUILD_PATH% "EDSEngine\EDSEngineTestApp\EDSEngineTestApp2013.vcxproj" /t:clean,rebuild /p:Configuration="Release" /p:VisualStudioVersion=12.0 /p:Platform=Win32
%MSBUILD_PATH% "EDSEngine\EDSEngineTestApp\EDSEngineTestApp2013.vcxproj" /t:clean,rebuild /p:Configuration="Debug" /p:VisualStudioVersion=12.0 /p:Platform=x64
%MSBUILD_PATH% "EDSEngine\EDSEngineTestApp\EDSEngineTestApp2013.vcxproj" /t:clean,rebuild /p:Configuration="Release" /p:VisualStudioVersion=12.0 /p:Platform=x64
copy "EDSEngine\EDSEngineTestApp\Release\EDSEngineTestApp2013.exe" VC12 /y
copy "EDSEngine\EDSEngineTestApp\x64\Release\EDSEngineTestApp2013.exe" VC12\x64 /y
...
%MSBUILD_PATH% "RelationalObjectModel\Relational Object Model 2013.vcxproj" /t:clean,rebuild /p:Configuration="Debug" /p:VisualStudioVersion=12.0 /p:Platform=Win32
%MSBUILD_PATH% "RelationalObjectModel\Relational Object Model 2013.vcxproj" /t:clean,rebuild /p:Configuration="Release" /p:VisualStudioVersion=12.0 /p:Platform=Win32
%MSBUILD_PATH% "RelationalObjectModel\Relational Object Model 2013.vcxproj" /t:clean,rebuild /p:Configuration="Debug" /p:VisualStudioVersion=12.0 /p:Platform=x64
%MSBUILD_PATH% "RelationalObjectModel\Relational Object Model 2013.vcxproj" /t:clean,rebuild /p:Configuration="Release" /p:VisualStudioVersion=12.0 /p:Platform=x64
copy "RelationalObjectModel\Release\*.lib" VC12 /y
copy "RelationalObjectModel\x64\Release\*.lib" VC12\x64 /y
echo "Relational Object Model build complete"

echo "Building ROMAppConsoleTest..."
%MSBUILD_PATH% "RelationalObjectModel\ROMAppConsoleTest\ROMAppConsoleTest2013.vcxproj" /t:clean,rebuild /p:Configuration="Debug" /p:VisualStudioVersion=12.0 /p:Platform=Win32
%MSBUILD_PATH% "RelationalObjectModel\ROMAppConsoleTest\ROMAppConsoleTest2013.vcxproj" /t:clean,rebuild /p:Configuration="Release" /p:VisualStudioVersion=12.0 /p:Platform=Win32
%MSBUILD_PATH% "RelationalObjectModel\ROMAppConsoleTest\ROMAppConsoleTest2013.vcxproj" /t:clean,rebuild /p:Configuration="Debug" /p:VisualStudioVersion=12.0 /p:Platform=x64
%MSBUILD_PATH% "RelationalObjectModel\ROMAppConsoleTest\ROMAppConsoleTest2013.vcxproj" /t:clean,rebuild /p:Configuration="Release" /p:VisualStudioVersion=12.0 /p:Platform=x64
copy "RelationalObjectModel\ROMAppConsoleTest\Release\ROMAppConsoleTest2013.exe" VC12 /y
copy "RelationalObjectModel\ROMAppConsoleTest\x64\Release\ROMAppConsoleTest2013.exe" VC12\x64 /y
...
echo "Building LogicianDebuggerTestApp2013 complete"
