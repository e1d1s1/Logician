/////////////////////////////////////////////////////////////////////////////
// Name:        CodeControl.h
// Purpose:     implementation for styled edit controls, based on wxWidgets sample
...
#include "CodeControl.h" // edit module
...
void Edit::LoadText (const wstring text, const wstring langType)
{
	ClearAll();
	InitializePrefs(langType);
	SetText(text);
	EmptyUndoBuffer();
}
