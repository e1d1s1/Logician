...
%MSBUILD_PATH% "EDSEngineNET\EDSEngineNETTestApp2010\EDSEngineNETTestApp.csproj" /t:clean,rebuild /p:Configuration="Debug"
%MSBUILD_PATH% "EDSEngineNET\EDSEngineNETTestApp2010\EDSEngineNETTestApp.csproj" /t:clean,rebuild /p:Configuration="Release"
echo "EDSEngineNETTestApp build complete"

echo "Building Relational Object Model..."
%MSBUILD_PATH% "RelationalObjectModel\Relational Object Model.vcxproj" /t:clean,rebuild /p:Configuration="Debug MSXML"
%MSBUILD_PATH% "RelationalObjectModel\Relational Object Model.vcxproj" /t:clean,rebuild /p:Configuration="Release MSXML"
copy "RelationalObjectModel\Release MSXML\*.lib" VC10 /y
echo "Relational Object Model build complete"

echo "Building ROMAppConsoleTest..."
%MSBUILD_PATH% "RelationalObjectModel\ROMAppConsoleTest\ROMAppConsoleTest.vcxproj" /t:clean,rebuild /p:Configuration="Debug MSXML"
%MSBUILD_PATH% "RelationalObjectModel\ROMAppConsoleTest\ROMAppConsoleTest.vcxproj" /t:clean,rebuild /p:Configuration="Release MSXML"
...
%MSBUILD_PATH% "ROMNET\ROMNETTestApplication2010\ROMNETTestApplication.csproj" /t:clean,rebuild /p:Configuration="Debug"
%MSBUILD_PATH% "ROMNET\ROMNETTestApplication2010\ROMNETTestApplication.csproj" /t:clean,rebuild /p:Configuration="Release"
